...
1. Select your last **12 posts** (excluding very recent ones less than 24 hours old).
2. Add up all the **Likes** on those posts.
3. Add up all the **Comments** on those posts.
4. Divide the total interactions (Likes + Comments) by **12** to find your averages.
5. Divide that average by your **Follower Count** and multiply by **100**.

For example, if you have 10,000 followers and average 450 likes and 50 comments per post:

$$\text{Interactions} = 450 + 50 = 500$$
$$\text{Engagement Rate} = \left( \frac{500}{10,000} \right) \times 100 = 5.00\%$$
